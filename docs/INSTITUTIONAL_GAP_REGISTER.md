...
| I-4 | **Alerting engine** on the live monitor: behind-schedule, participation-breach, limit-breach, toxicity-spike, reversion alerts with severity levels | EMS alert blotter | Threshold rules over the existing live metrics (Agent 11 outputs); UI badge/log with acknowledge |
...
| I-6 | **Explicit costs model**: commissions, exchange fees/rebates (maker-taker), taxes/stamp duty per market | Commission schedules, fee engines | Static per-market fee table; feeds I-2 and I-5 |
