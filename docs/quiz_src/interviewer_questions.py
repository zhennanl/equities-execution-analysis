# Interviewer-specific prep bank. Tiers: 1 = highly likely given her
# background, 2 = likely, 3 = possible.
TIER_LABELS = {1: "T1 · Highly likely (her home turf)", 2: "T2 · Likely", 3: "T3 · Possible"}

INTRO = """## Reading the interviewer
